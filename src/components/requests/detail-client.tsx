...
import type { LearningRequest, RequestApplication } from "@/lib/mock/requests";
          ...
          <div className="lg:col-span-8">
            ...
            <Tabs defaultValue="applications" className="mt-8">
              ...
              <TabsContent value="timeline">
                <TimelinePanel request={request} awardedId={awardedId} />
              </TabsContent>
            </Tabs>
          </div>
...
function DiscussionPanel() {
  const t = useTranslations("requests");
  return (
    <div className="mt-6 grid place-items-center rounded-[var(--radius-lg)] border border-dashed border-border bg-surface/40 p-12">
      ...
      {isOwner && (
        <div className="rounded-[var(--radius-lg)] border border-border bg-card p-5">
          ...
          <div className="mt-4 space-y-2">
            <Button asChild variant="outline" size="md" className="w-full justify-start">
            ...
            {request.status !== "closed" ? (
              <Button variant="ghost" size="md" className="w-full justify-start text-danger hover:bg-danger/10 hover:text-danger">
