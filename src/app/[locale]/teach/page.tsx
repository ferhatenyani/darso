  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-10 lg:px-8 lg:py-12">
      ...
      <section className="relative mb-10 lg:mb-14">
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1fr_auto] lg:items-end lg:gap-10">
          <div className="space-y-3">
            ...
            <h1 className="text-balance text-[44px] font-semibold leading-[1.05] tracking-tight text-foreground sm:text-[56px] lg:text-[64px]">
              {t("greetingDay")},
              <br />
              ...
              >
                <header className="flex items-center gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="truncate text-[13px] font-semibold text-foreground">{r.student.name[loc]}</p>
                    <p className="truncate text-[11px] text-ink-3 tabular">
                      {r.student.location[loc]} · {r.sentAt[loc]}
                    </p>
                  </div>
                </header>
                <p className="mt-2 line-clamp-2 text-[12px] text-ink-2">{r.excerpt[loc]}</p>
                <div className="mt-3 flex gap-2">
                  <Button size="sm" variant="primary" className="h-8 flex-1 text-[12px]">
                    <Check className="h-3 w-3" aria-hidden />
                    {t("inbox.accept")}
                  </Button>
                  <Button size="sm" variant="outline" className="h-8 flex-1 text-[12px]">
      ...
      <div className="mt-12 flex items-center gap-3 text-[10px] uppercase tracking-[0.16em] text-ink-3">
        ...
        <span className="tabular">v 1.0 · {tcommon("loading")}</span>
        <span className="h-px flex-1 bg-border" aria-hidden />
      </div>
    </div>
  );
